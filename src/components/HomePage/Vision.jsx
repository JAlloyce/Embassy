...
const Vision = () => {
  return (
    <div className="bg-black py-8"> {/* Added a black background for the margin area */}
      <div className="relative bg-cover bg-center h-80 sm:h-96 lg:h-[360px]" style={{ backgroundImage: `url(${images.Flag})` }}>
        ...
        <a href="#" className="absolute right-6 bottom-6 flex items-center">
