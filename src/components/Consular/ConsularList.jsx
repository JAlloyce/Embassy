        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <motion.div
            ...
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold leading-7 text-indigo-600">{t('consular.title')}</p>
              <h1 className="mt-2 text-5xl font-bold tracking-tight text-white sm:text-6xl">{t('consular.title')}</h1>
              <p className="mt-6 text-2xl leading-8 text-gray-400">
                {t('consular.description')}
              </p>
            </div>
          </motion.div>
        </div>
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/visa" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">1.</span> {t('consular.visa.title')}
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/passports" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">2.</span> {t('consular.passport.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/good-conduct" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">3.</span> {t('consular.goodConduct.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/marriage" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">4.</span> {t('consular.marriage.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/pets" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">5.</span> {t('consular.pets.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/birth" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">6.</span> {t('consular.birth.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/doc-auth" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">7.</span> {t('consular.docAuth.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/doc-leg" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">8.</span> {t('consular.docLeg.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                  ...
                  <div className="flex min-w-0 gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <Link to="/consular/downloads" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                        <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">9.</span> {t('consular.downloads.title')}
                      </Link>
                    </div>
                  </div>
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
