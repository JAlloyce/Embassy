            ...
            <div className="lg:pr-4">
                ...
                <ul role="list" className="mt-[20px] space-y-[10px]">
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        ...
                        <Link to="/intro" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/nairobi-city" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">2.</span> Nairobi City
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/nairobi-city">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/coast-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">3.</span> Coast Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/coast-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/central-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">4.</span> Central Rift Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/central-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/mount-kenya" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/northern-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">6.</span> Northern Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/northern-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/north-rift-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">7.</span> North Rift Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/north-rift-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/southern-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">8.</span> Southern Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/southern-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/western-region" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">9.</span> Western Region
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                        <Link to="/western-region">
                        <ArrowRightIcon aria-hidden="true" className="mt-1 h-10 w-10 flex-none text-indigo-600 hover:text-white" />
                        </Link>
                    </div>
                    </li>
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/things-to-do" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/tourism" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">11.</span> Tourism
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
                    ...
                    <div className="flex min-w-0 gap-x-4">
                        <div className="min-w-0 flex-auto">
                        <Link to="/outro" className="text-4xl font-bold leading-6 text-gray-400 hover:text-white">
                            <span className="rounded-full bg-indigo-600 px-3 py-2 text-2xl font-bold text-white">12.</span> Outro
                        </Link>
                        </div>
                    </div>
                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-start">
