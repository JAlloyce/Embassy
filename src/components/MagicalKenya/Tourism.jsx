  ...
  return (
    <div className="relative isolate overflow-hidden bg-black px-6 py-12 sm:py-12 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10">
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-indigo-600">{t('explore.tourism.safaris')}</h2>
            <motion.div
          ...
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-indigo-600">{t('explore.tourism.cuisine')}</h2>
            <motion.div
              initial={{x:-100, opacity:0}}
              animate={{x:0, opacity:1}}
              transition={{duration:1, delay:0.5}}
          ...
          <div className="mt-6">
            <h2 className="text-2xl font-semibold text-indigo-600">{t('explore.tourism.experiences')}</h2>
            <motion.div
              initial={{x:-100, opacity:0}}
              animate={{x:0, opacity:1}}
              transition={{duration:1, delay:0.5}}
