        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg mt-8 sm:mt-12">
              <p className="text-base font-semibold leading-7 text-indigo-600">{t('explore.culture.title')}</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">{t('explore.culture.title')}</h1>
              ...
              <ul role="list" className="mt-[20px] space-y-[10px]">
                <li className="flex gap-x-[10px]">
                  ...
                  <span className='text-justify'>
                    <strong className="font-semibold text-white">{t('explore.culture.festivals')}</strong>
                ...
                <li className="flex gap-x-[10px]">
                  <ArrowRightIcon aria-hidden="true" className="mt-[6px] h-[20px] w-[20px] flex-none text-indigo-600" />
                  <span className='text-justify'>
                    <strong className="font-semibold text-white">{t('explore.culture.museums')}</strong>
                ...
                <li className="flex gap-x-[10px]">
                  <ArrowRightIcon aria-hidden="true" className="mt-[6px] h-[20px] w-[20px] flex-none text-indigo-600" />
                  <span className='text-justify'>
                    <strong className="font-semibold text-white">{t('explore.culture.wildlife')}</strong>
